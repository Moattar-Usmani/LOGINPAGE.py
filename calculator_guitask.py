...
#***********Buttons*************#
            ...
            self.resultlabel = Label(self.frame3,width= 20, justify=CENTER,text= 'answer',font=("Times New Roman", 16,'bold'),bg= 'white')

            wellabel.pack(side=TOP, pady=10, padx=100)
            frame1.pack(side=TOP, fill=BOTH, expand=1)
            self.num1.pack(side= LEFT, padx=10, pady= 20)
            self.num2.pack(side= RIGHT, padx=10, pady= 20)
